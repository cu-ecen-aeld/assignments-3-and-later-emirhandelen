...
void test_validate_my_username()
{
    ...
    char *config_file_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(hard_coded_username, config_file_username, 
        "The hard coded username should match the username in /conf/username.txt");
    /**
